class LineItemDatesController < ApplicationController
  before_action :find_and_set_quote
  before_action :find_and_set_line_item_date, only: [:edit, :update, :destroy]
  ...
  def find_and_set_quote
    @quote = current_company.quotes.find params[:quote_id]
  end

  def find_and_set_line_item_date
